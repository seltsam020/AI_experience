...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        # training parameters
        #parser.add_argument('--dataroot', type=str, default="./datasets/grumpifycat ", help='dataroot')
        #parser.add_argument('--name', type=str, default="grumpycat_CUT", help='name')
        #parser.add_argument('--CUT_mode', type=str, default="CUT", help='cutmood')
