...
class R2U_Net(nn.Module):
    def __init__(self, img_ch=3, num_classes=1, t=2):
...
class Dense_Unet(nn.Module):
    def __init__(self, img_ch=3,num_classes=2,filters=128, num_conv=4):

        super(Dense_Unet, self).__init__()
        self.conv1 = nn.Conv2d(img_ch, filters, 1)
        ...
        self.outconv = nn.Conv2d(filters, num_classes, 1)
...
class NestedUNet(nn.Module):
    def __init__(self, deep,img_ch,num_classes):
        super().__init__()
